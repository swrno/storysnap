...
import { Upload, X, Loader2, MapPin, Calendar, PenTool, Plus } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="mb-8">
              <h1 className="text-4xl font-bold text-gray-900 mb-2">Share Your Story</h1>
              <p className="text-gray-600">Document historical places and their fascinating stories</p>
            </div>
