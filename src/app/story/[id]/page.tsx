            ...
            {user ? (
              <>
                <button
                  ...
                  className="bg-black text-white px-4 py-2 rounded-full font-semibold text-sm hover:opacity-90 transition-all flex items-center gap-2"
                >
              ...
              <button
                ...
                className="bg-black text-white px-6 py-2 rounded-full font-semibold text-sm hover:opacity-90 transition-all"
              >
                Sign In
              </button>
            )}
            ...
            >
              ...
              {story.images.length > 1 && (
                ...
                <div className="px-8 sm:px-12 lg:px-16 py-10">
                  <div className="flex items-start justify-between mb-8">
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-4">
                          <h1 className="text-4xl font-bold text-gray-900">{translatedTitle || story.title}</h1>
                          {isAdmin && (
                            <button
                  ...
                  <div className="prose prose-2xl max-w-none prose-headings:font-playfair prose-h1:text-6xl prose-h1:mb-12 prose-h2:text-5xl prose-h2:mb-10 prose-h3:text-4xl prose-h3:mb-8 prose-p:text-gray-800 prose-p:leading-loose prose-p:mb-6 prose-p:text-lg prose-a:text-black prose-strong:text-gray-900 prose-ul:list-disc prose-ol:list-decimal prose-li:mb-3">
                    {isTranslating ? (
                      ...
                      <ReactMarkdown
                        ...
                        components={{
                          h1: ({ children }) => {
                            ...
                            const id = generateId(text);
                            return <h1 id={id} className="text-4xl font-bold mb-8 mt-12 font-playfair text-gray-900">{children}</h1>;
                          },
                          h2: ({ children }) => {
                            const text = String(children);
                            const id = generateId(text);
                            return <h2 id={id} className="text-3xl font-bold mb-6 mt-10 font-playfair text-gray-900">{children}</h2>;
                          },
                          h3: ({ children }) => {
                            const text = String(children);
                            const id = generateId(text);
                            return <h3 id={id} className="text-2xl font-bold mb-4 mt-8 font-playfair text-gray-900">{children}</h3>;
                          },
                          p: ({ children }) => (
                            <p className="text-lg mb-6 leading-loose text-gray-800 font-normal">
                              {children}
                            </p>
                          ),
                          img: ({ src, alt }) => (
